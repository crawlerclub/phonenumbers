...
const (
	...
	metadataPath = `src/github.com/crawlerclub/phonenumbers/metadata_bin.go`

	tzURL  = `https://raw.githubusercontent.com/googlei18n/libphonenumber/master/resources/timezones/map_data.txt`
	tzPath = `src/github.com/crawlerclub/phonenumbers/prefix_to_timezone.go`

	regionPath = `src/github.com/crawlerclub/phonenumbers/countrycode_to_region.go`
)
...
var carrier = Build{
	...
	srcGlob: "./carrier/*/*.txt",
	dstFile: `src/github.com/crawlerclub/phonenumbers/carriers_txt.go`,
	varName: "Carriers",
}
...
var geocoding = Build{
	...
	dstFile: `src/github.com/crawlerclub/phonenumbers/geocodings_txt.go`,
	varName: "Geocodings",
}
